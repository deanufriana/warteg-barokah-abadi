      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 flex flex-col md:flex-row justify-between items-center gap-12 text-center md:text-left">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center justify-center md:justify-start gap-4 mt-2">
            <a href="#" className="h-10 w-10 rounded-full bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center text-zinc-600 dark:text-zinc-400 hover:bg-brand hover:text-white transition-all">
              <Mail size={18} />
            </a>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6 items-center md:items-end">
          ...
          <div className="flex flex-col items-center md:items-end gap-1">
            <div className="text-[11px] uppercase tracking-[0.3em] font-bold text-zinc-400 flex items-center gap-2">
              Website by <a href="https://deanufriana.github.io/" target="_blank" className="text-zinc-600 dark:text-zinc-300 hover:text-brand transition-colors">deanufriana</a> &copy; 2026
            </div>
            <a 
              href="https://deanufriana.github.io/" 
              target="_blank"
