  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <a
            href={BUSINESS.whatsappUrl("Halo Warteg Barokah, saya ingin memesan makanan.")}
            target="_blank"
            rel="noopener noreferrer"
            onClick={() => trackEvent("click_whatsapp_fab", { location: "fab" })}
            className="flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-2xl shadow-emerald-500/40 hover:bg-[#1DA851] transition-colors group relative"
